...
namespace Eventos.IO.Domain.CommandHandlers
{
    public abstract class CommandHandler
    {
        ...
        protected bool Commit()
        {
            ...
            Console.WriteLine("Ocorreu um erro ao salvar no banco de dados");
            _bus.RaiseEvent(new DomainNotification("Commit", "Ocorreu um erro ao salvar no banco de dados"));
            return false;
        }
    }
}